    ...
    if (!window.museConfigLoadedAndExecuted) {
        ...
        var d = {
            ...
            paths: {
                ...
                "jquery.museoverlay": "scripts/jquery.museoverlay.js?crc=521872101",
                ...
                "museutils": "scripts/museutils.js?crc=109723140",
                "musewpdisclosure": "scripts/musewpdisclosure.js?crc=504240800",
                "musewpslideshow": "scripts/musewpslideshow.js?crc=3840778953",
                ...
                "webpro": "scripts/webpro.js?crc=84353028",
        ...
        if (-1 != a) {
            ...
            for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
                ...
                if ("generator" == d.getAttribute("name")) {
                    "2017.0.2.363" != d.getAttribute("content") && Muse.assets.outOfDate.push("museconfig.js");
                    break
                }
            }
        }
