...
APPS_DIR = ROOT_DIR.path('helpinghand')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'helpinghand.contrib.sites.migrations'
}
...
ADMINS = (
    ("""Natthawut Adulyanukosol""", 'natthawut.adul@gmail.com'),
)
...
if False:
    DATABASES = {
        ...
        'default': env.db("DATABASE_URL", default="postgres:///helpinghand"),
    }
